 ...
 * @author JC
 */
public class Vista_Cliente_Inactivos extends javax.swing.JFrame {

    /**
     * Creates new form Vista_Cliente_Inactivos
     */
    public Vista_Cliente_Inactivos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_Cliente_Inactivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vista_Cliente_Inactivos().setVisible(true);
            }
        });
    }
